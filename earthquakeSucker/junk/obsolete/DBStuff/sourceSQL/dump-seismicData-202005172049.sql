...
CREATE TABLE `USGSData` (
  ...
  KEY `eqid` (`EQID`),
  KEY `place` (`PLACE`)
) ENGINE=InnoDB AUTO_INCREMENT=219459 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `geoJsonEvents` (
  ...
  `feaureType` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2020-05-17 20:49:21
