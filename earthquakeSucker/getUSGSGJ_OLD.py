...
# thisUrl = "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2021-12-01&endtime=2022-01-13"
if myOffset == 0:
  thisUrl = C.GEOJSONALLSMRY("month")
  print("month")
#elif myOffset > 0:
#  thisUrl = f"""{C.GEOJSONQUERY(f"&limit=10000&starttime=2021-12-01&endtime=2022-01-13&offset={myOffset}")}"""
# elif myOffset == -1:
...
24680246802468024680246802468024680246802468024680
"""
...
if myLocation.find("DEV") > -1:
  ...
  myTableName = f"{C.GEOJSONEVENTSTABLENAME}"  # normally contains Test after the }
else:
...
""")
  ...
  # thisFilename = WEB.jsonSplitAFile(thisFilename)
else:
  thisFilename = argv[1]
...
def __main__():
  ...
  print(f"""
opening file""")
  with open(thisFilename, "tr") as FIn, \
      open("oneAtATime.txt", "tw") as FOut:
    print(f"""
loading file""")
    print(f"""
...
{destProgressBar}""", end="")
    for thisFeature in myFeatures:
      ...
      if (
          (thisFeature.properties["place"] in C.EMPTY_STR_LST)
      ):
        thisFeature.properties["place"] = "`empty`"
      # * ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱ ⟰3⟱
      # * ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰3 ⟰34
#      print(f"""thisFeature = |{thisFeature}|""")
      outStr = f"""
{thisFeature}

{thisFeature["properties"]["place"]}
{len(thisFeature["properties"]["place"])}
"""
#      print(f"""outstr = |{outStr}|""")
      FOut.write(outStr)
      if len(thisFeature["properties"]["place"]) > 250:
        thisFeature["properties"]["place"] = "too long " + thisFeature["properties"]["place"][:200]
