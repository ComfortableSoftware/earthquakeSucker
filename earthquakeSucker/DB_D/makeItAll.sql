...
CREATE TABLE `GJ_events` (
  ...
  `geoDepth` decimal(40,5) DEFAULT 0.0,
  ...
  `geoLat` decimal(40,5) DEFAULT 0.0,
  `geoLon` decimal(40,5) DEFAULT 0.0,
  ...
  `propDegMinToStation` decimal(40,5) DEFAULT 0.0,
  `propDepthErr` decimal(40,5) DEFAULT 0.0,
  ...
  `propMag` decimal(40,5) DEFAULT 0.0,
  `propMaxAzmGap` decimal(40,5) DEFAULT 0.0,
  `propMaxMeasuredIntensity` decimal(40,5) DEFAULT 0.0,
  ...
  `propRMS` decimal(40,5) DEFAULT 0.0,
...
CREATE TABLE `GJ_files` (
  `RID` int(11) NOT NULL AUTO_INCREMENT,
  `BBoxMaxDepth` decimal(40,5) DEFAULT 0.0,
  `BBoxMaxLat` decimal(40,5) DEFAULT 0.0,
  `BBoxMaxLon` decimal(40,5) DEFAULT 0.0,
  `BBoxMinDepth` decimal(40,5) DEFAULT 0.0,
  `BBoxMinLat` decimal(40,5) DEFAULT 0.0,
  `BBoxMinLon` decimal(40,5) DEFAULT 0.0,
