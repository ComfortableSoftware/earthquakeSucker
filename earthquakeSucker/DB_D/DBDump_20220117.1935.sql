...
--
-- Dumping data for table `GJ_enumerated`
--

LOCK TABLES `GJ_enumerated` WRITE;
/*!40000 ALTER TABLE `GJ_enumerated` DISABLE KEYS */;
/*!40000 ALTER TABLE `GJ_enumerated` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `GJ_events` (
  ...
  `geoDepth` decimal(40,5) DEFAULT 0.00000,
  `geoHomeLat` decimal(40,5) DEFAULT 41.00000,
  `geoHomeLon` decimal(40,5) DEFAULT -112.00000,
  `geoKMFROMHM` decimal(40,5) GENERATED ALWAYS AS (atan(sqrt(pow(cos(radians(`geoHomeLat`)) * sin(radians(`geoHomeLon`) - radians(`geoLon`)),2) + pow(cos(radians(`geoLat`)) * sin(radians(`geoHomeLat`)) - sin(radians(`geoLat`)) * cos(radians(`geoHomeLat`)) * cos(radians(`geoHomeLon`) - radians(`geoLon`)),2)),sin(radians(`geoLat`)) * sin(radians(`geoHomeLat`)) + cos(radians(`geoLat`)) * cos(radians(`geoHomeLat`)) * cos(radians(`geoHomeLon`) - radians(`geoLon`))) * 6371) STORED,
  `geoLat` decimal(40,5) DEFAULT 0.00000,
  `geoLon` decimal(40,5) DEFAULT 0.00000,
  ...
  `propDegMinToStation` decimal(40,5) DEFAULT 0.00000,
  `propDepthErr` decimal(40,5) DEFAULT 0.00000,
  ...
  `propMag` decimal(40,5) DEFAULT 0.00000,
  `propMaxAzmGap` decimal(40,5) DEFAULT 0.00000,
  `propMaxMeasuredIntensity` decimal(40,5) DEFAULT 0.00000,
  ...
  `propRMS` decimal(40,5) DEFAULT 0.00000,
...
LOCK TABLES `GJ_events` WRITE;
/*!40000 ALTER TABLE `GJ_events` DISABLE KEYS */;
INSERT INTO `GJ_events` VALUES (1,0,'','',0,0.00000,41.00000,-112.00000,111.19493,40.00000,-112.00000,'','','',0,0.00000,0.00000,'','',0,'','',0.00000,0.00000,0.00000,'',0,'','',0.00000,0,'','',NULL,'',0,0,NULL,NULL,'');
/*!40000 ALTER TABLE `GJ_events` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `GJ_files` (
  `RID` int(11) NOT NULL AUTO_INCREMENT,
  `BBoxMaxDepth` decimal(40,5) DEFAULT 0.00000,
  `BBoxMaxLat` decimal(40,5) DEFAULT 0.00000,
  `BBoxMaxLon` decimal(40,5) DEFAULT 0.00000,
  `BBoxMinDepth` decimal(40,5) DEFAULT 0.00000,
  `BBoxMinLat` decimal(40,5) DEFAULT 0.00000,
  `BBoxMinLon` decimal(40,5) DEFAULT 0.00000,
...
--
-- Dumping data for table `GJ_files`
--

LOCK TABLES `GJ_files` WRITE;
/*!40000 ALTER TABLE `GJ_files` DISABLE KEYS */;
/*!40000 ALTER TABLE `GJ_files` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `GJ_queries`
--

LOCK TABLES `GJ_queries` WRITE;
/*!40000 ALTER TABLE `GJ_queries` DISABLE KEYS */;
/*!40000 ALTER TABLE `GJ_queries` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-01-17 19:35:49
